...
| 2 | FD of AD-gradient (baseline) | 30 | 9.18e-7 | 837 μs |
| 6 | FD of analytical gradient (fused basis) | 104 | 9.18e-7 | 164 μs |
| 3 | Nested AD, naïve basis | 118 | 3.34e-18 | 1.05 ms |
| 4 | Nested AD, fused basis (oracle) | 30 | 0 (reference) | 1.09 ms |
| 5 | Seeded AD of analytical gradient, naïve basis | (102) | NaN (depth-0 §IV.B trap) | — |
| 7 | Seeded AD of analytical gradient, fused basis (recipe) | 102 | 1.30e-16 | 187 μs |
| 8 | Auto FoR (`UnsafeCell` tape, no analytical grad) | 30 | 2.54e-16 | 456 μs |
<!-- HESSIAN_TABLE_END -->
