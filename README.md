...
| 2 | FD of AD-gradient (baseline) | 30 | 9.18e-7 | 759 μs |
| 6 | FD of analytical gradient (fused basis) | 104 | 9.18e-7 | 161 μs |
| 3 | Nested AD, naïve basis | 118 | 3.34e-18 | 991 μs |
| 4 | Nested AD, fused basis (oracle) | 30 | 0 (reference) | 1.03 ms |
| 5 | Seeded AD of analytical gradient, naïve basis | (102) | NaN (depth-0 §IV.B trap) | — |
| 7 | Seeded AD of analytical gradient, fused basis (recipe) | 102 | 1.30e-16 | 169 μs |
